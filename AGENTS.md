...
read-only dashboard artifacts, and current-head READY agreement.
Deferred: preflight, counterfactual automerge log, treehouse pools,
ACP role driving, and richer dashboard interactivity.
