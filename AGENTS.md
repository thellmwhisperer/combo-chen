...
no-mistakes config propagation, and current-head READY agreement. Deferred:
preflight, counterfactual automerge log, treehouse pools, ACP role driving,
and multi-combo dashboarding.
