#!/usr/bin/env node
/**
 * @overview combo-chen CLI router — ~840 lines, 19 commands, dependency wiring only.
 *
 *   READING GUIDE
 *   -------------
 ...
 *   ../core/{combo,events,state}, ../infra/{config,config-snapshot,release-metadata,tmux}, ../roles/{coder,gatekeeper,reviewer},
