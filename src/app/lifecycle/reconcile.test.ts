/**
 * @overview Unit tests for reconcile command helpers. ~530 lines, frozen journal repair.
 *
 *   READING GUIDE
 *   -------------
 ...
 *
 * @exports none
 * @deps ../../core/events, ../../core/runtime-ledger, ../../core/state, ../../infra/config, ../../infra/config-snapshot, ./reconcile, node:fs, node:os, node:path, vitest
 */
