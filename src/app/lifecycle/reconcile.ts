 ...
 * @deps ../../core/events, ../../core/guards, ../../core/runtime-ledger, ../../core/state, ../../infra/config-snapshot, ../../infra/tmux, ../director/reviewer, ../github/github, ../runtime/sessions, ./teardown
 */
...
import { parsePrView, type GhResult, type PrView } from "../github/github.js";
import { teardownMergedCombo } from "./teardown.js";
import { hasMergedEvent, terminalReviewerEvent } from "../director/reviewer.js";
import { readRuntimeLedger } from "../../core/runtime-ledger.js";
import { killComboSession } from "../runtime/sessions.js";
