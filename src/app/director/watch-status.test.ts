/**
 * @overview Unit tests for supervisor tick operator status formatting. ~215 lines,
 ...
 *
 * @exports none
 * @deps ../../core/events, ./watch-status, vitest
 */
import { describe, expect, it } from "vitest";

import type { ComboEvent } from "../../core/events.js";
import { buildDirectorWatchStatusLine } from "./watch-status.js";
