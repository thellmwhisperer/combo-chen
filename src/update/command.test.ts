 ...
 *
 * @exports none
 * @deps ../core/active-runtime, ./command, node:child_process, node:fs, node:os, node:path, vitest
 */
...
import { defaultUpdateCommandDeps } from "./command.js";
...
describe("defaultUpdateCommandDeps", () => {
  ...
  it("bounds post-update no-mistakes daemon refresh with a timeout", async () => {
    ...
    try {
      const { defaultUpdateCommandDeps: mockedDefaultUpdateCommandDeps } = await import("./command.js");
