 ...
 *
 * @exports none
 * @deps vitest, node:{child_process,fs,path,url}, ../src/core/release-artifacts, ../src/infra/release-producer, ../src/update/index
 */
...
import { PASSIVE_UPDATE_DISABLE_ENV } from "../src/update/index.js";
